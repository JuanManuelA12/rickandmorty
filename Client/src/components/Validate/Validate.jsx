...
export const validate = (inputs) => {
  ...
  if (!Pass.mayor.test(inputs.password))
    errors.password = "*Debe tener mas de 8 caracteres";
  if (!Pass.minus.test(inputs.password))
    errors.password = "*Debe contener al menos 1 carácter en minúscula";
  if (!Pass.mayus.test(inputs.password))
    errors.password = "*Debe contener al menos 1 carácter en mayúscula";
  if (!Pass.num.test(inputs.password))
    errors.password = "*Debe contener al menos 1 carácter numérico";
